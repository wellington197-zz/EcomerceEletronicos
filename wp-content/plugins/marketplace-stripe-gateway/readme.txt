...
> - <strong>No need to install Marketplace Stripe Gateway plugin separately. Marketplace Stripe is now merged with WC Marketplace core from version 3.1.0.</strong>
...
= 1.0.9.1 =
* Deprecated: Marketplace stripe is now merged with WC Marketplace core from version 3.1.0.
