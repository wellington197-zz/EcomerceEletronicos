...
class WCMp_Stripe_Gateway_Admin {
    ...
    public function __construct() {
        ...
        if (class_exists('WCMp') && 'Enable' === get_wcmp_vendor_settings('payment_method_stripe_masspay', 'payment')) {
    ...
    function wcmp_tabsection_payment_callback($submenue_tab) {
        $submenue_tab['stripe_gateway'] = array('title' => __('Stripe Gateway', 'marketplace-stripe-gateway'), 'icon' => 'dashicons-tickets-alt');
        return $submenue_tab;
    }
    /**
