...
if (WCMp_Dependencies_Stripe_Gateway::wcmp_version_check() && WCMp_Dependencies_Stripe_Gateway::woocommerce_plugin_active_check()) {
    ...
    add_action('admin_notices', 'marketplace_stripe_deprecated');
}
