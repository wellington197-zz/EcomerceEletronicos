...
(function() {
	wp.customize.bind( 'ready', function() {
		...
		function hideShowColorControls2() {
			var colorControlIds = [
				'header_top_left_info'
			];
			var bgColorControlId = '#customize-control-allo_header_variation';
			if ( wp.customize.instance( 'allo_header_variation' ).get() === 'header_two' ) {
			...
			return hideShowColorControls2;
		}
		hideShowColorControls2();	
		// ... and on radio button change
		$( '#customize-control-allo_header_variation' ).on( 'change', hideShowColorControls2 );
	});
})( jQuery );
