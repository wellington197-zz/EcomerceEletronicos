 ...
 * @since 1.1.38
 */
function allo_get_standard_fonts() {
	return apply_filters(
		'allo_standard_fonts_array', array(
 ...
 * @since 1.0
 */
function allo_enqueue_google_font( $font ) {
	...
	$subsets     = '';
	$get_subsets = get_theme_mod( 'allo_font_subsets', array( 'latin' ) );
	...
	// Weights
	$weights = apply_filters( 'allo_font_weights', array( '300', '400', '500', '700' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'allo-google-font-' . $handle, $url, array(), false );
}