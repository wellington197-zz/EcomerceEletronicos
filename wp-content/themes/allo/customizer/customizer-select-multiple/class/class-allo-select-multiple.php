 ...
 * @access public
 */
class Allo_Select_Multiple extends WP_Customize_Control {
	/**
	...
	/**
	 * Allo_Select_Multiple constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'allo-customizer-select-multiple', TL_ALLO_TEMPLATE_DIR_URL . '/customizer/customizer-select-multiple/js/script-allo-select-multiple.js', array( 'jquery', 'customize-base' ), TL_ALLO_VERSION, true );
	}
	/**
