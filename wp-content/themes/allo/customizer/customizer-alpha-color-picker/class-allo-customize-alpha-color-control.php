...
/**
 * Class Allo_Customize_Alpha_Color_Control
 */
class Allo_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'allo_alpha-color-picker', TL_ALLO_TEMPLATE_DIR_URL . '/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js', array( 'jquery', 'wp-color-picker' ),TL_ALLO_VERSION, true	);
		wp_enqueue_style('allo_alpha-color-picker', TL_ALLO_TEMPLATE_DIR_URL . '/customizer/customizer-alpha-color-picker/css/alpha-color-picker.css', array( 'wp-color-picker' ),
			TL_ALLO_VERSION	);
	}
	/**
	 * Render the control.
