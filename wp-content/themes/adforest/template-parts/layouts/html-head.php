...
<?php if( isset( $adforest_theme['sb_color_plate'] ) && $adforest_theme['sb_color_plate'] ) { ?>
 <div class="color-switcher" id="choose_color"><a href="#" class="picker_close"><i class="fa fa-gear"></i></a><h5><?php echo __ ( 'STYLE SWITCHER', 'adforest' ); ?></h5> <div class="theme-colours"><p> <?php echo __ ( 'Choose Colour style', 'adforest' ); ?> </p><ul><li><a href="#." class="defualt" id="defualt"></a></li><li>   <a href="#." class="green" id="green"></a></li><li>   <a href="#." class="blue" id="blue"></a></li><li>   <a href="#." class="red" id="red"></a></li><li>   <a href="#." class="sea-green" id="sea-green"></a></li></ul></div><div class="clearfix"></div></div>
	<?php } ?>
    <?php
